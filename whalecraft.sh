...
PACKAGES="tlp tlp-rdw thermald lm_sensors htop iotop bc plymouth pipewire pipewire-pulse pipewire-alsa wireplumber pavucontrol helvum qpwgraph alsa-utils"
